const SINONIMOS = {
  ...
  // Endereço (unificado em uma única coluna)
  endereco:'endereco', logradouro:'endereco', address:'endereco',
  rua:'endereco', r:'endereco',
  avenida:'endereco', av:'endereco',
  alameda:'endereco', al:'endereco',
  travessa:'endereco', tv:'endereco', trav:'endereco', tr:'endereco',
  estrada:'endereco', est:'endereco',
  rodovia:'endereco', rod:'endereco', br:'endereco', sp:'endereco',
  fazenda:'endereco', faz:'endereco', sitio:'endereco', loteamento:'endereco', lot:'endereco',
  numero:'endereco', nro:'endereco', nr:'endereco', num:'endereco',
  complemento:'endereco', apto:'endereco', apt:'endereco', ap:'endereco',
  bloco:'endereco', bl:'endereco', quadra:'endereco', qd:'endereco',
  conjunto:'endereco', conj:'endereco',
